---
{
  ...
  'references': ['https://leetcode.com/problems/array-reduce-transformation/description/'],
  'flag': 'Y',
}
---
...
const reduce = (nums: number[], fn: Fn, init: number) =>
  nums.reduce((pre, cur) => fn(pre, cur), init);
```
